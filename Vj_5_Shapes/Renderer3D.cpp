...
#include "..\Vanity\Vanity\Library\Engine\Models\Basic Shapes\Pyramids.h"
#include "..\Vanity\Vanity\Library\Engine\Models\Basic Shapes\Cubes.h"
#include "..\Vanity\Vanity\Library\Engine\Models\Basic Shapes\Triangles.h"
#include "..\Vanity\Vanity\Library\Engine\Models\Explicit Surface.h"
...
namespace vxe
{
    ...
    void Renderer3D::CreateDeviceDependentResources(void)
    {
        ...
        //_model = std::make_shared<Pyramid<DirectX::VertexPositionColor, unsigned short>>();
        //_model = std::make_shared<Cube<DirectX::VertexPositionColor, unsigned short>>();
        //_model = std::make_shared<Triangle<DirectX::VertexPositionColor, unsigned short>>();
